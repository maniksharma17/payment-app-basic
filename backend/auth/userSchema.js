...
const signupSchema = z.object({
    username: z.string().email().min(3, {message: "Username must be greater than 3 characters."}).max(20, {message: "Username must be less than 10 characters."}).trim().toLowerCase(),
